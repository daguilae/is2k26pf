...
INSERT INTO `tbl_clientes` VALUES (1,'96459641964','armando ','Barrera','61616161','armando@mail.com',118456,'zona 2',1,'Activo'),(2,'334344','Ruben','luch','3434344','rlopez@mail.com',119188,'zona 2',1,'Activo'),(3,'343443','Maria','Zardoya','61616161','themarias@mail.com',222,'zona 2',1,'Activo');
...
CREATE TABLE `tbl_comprobante_compra` (
  ...
  CONSTRAINT `fk_comprobante_compra_entrega`
  FOREIGN KEY (`Fk_ID_Entrega_Compra`)
  REFERENCES `tbl_entrega_compra` (`Pk_Id_Entrega_Compra`)
  ON DELETE CASCADE
  ON UPDATE CASCADE,

  CONSTRAINT `fk_comprobante_compra_proveedor`
  FOREIGN KEY (`Fk_ID_Proveedor`)
  REFERENCES `tbl_proveedores` (`pk_id_proveedor`)
  ON DELETE CASCADE
  ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `tbl_detalle_devolucion_ventas` (
    ...
    CONSTRAINT `fk_detalle_devolucion` FOREIGN KEY (`Fk_Id_Devolucion_Ventas`) REFERENCES `tbl_devolucion_ventas` (`Pk_Id_Devolucion_Ventas`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
    CONSTRAINT `fk_detalle_devolucion_inventario` FOREIGN KEY (`Fk_Id_Inventario`) REFERENCES `tbl_inventario` (`pk_inventario_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
) ENGINE=InnoDB
...
INSERT INTO `tbl_detalle_devolucion_ventas` VALUES (1,1,1,18.50);
...
CREATE TABLE `tbl_devolucion_ventas` (
  ...
  `Cmp_Estado` enum('Activo','Inactivo') DEFAULT 'Activo',
  PRIMARY KEY (`Pk_Id_Devolucion_Ventas`), KEY `Fk_Id_Venta` (`Fk_Id_Venta`),
...
INSERT INTO `tbl_devolucion_ventas`VALUES (1,2,'2026-05-16 10:30:00','Producto defectuoso',18.50,'Activa');
...
INSERT INTO `tbl_existencias` VALUES (1,1,149,NULL,1,3),(2,1,47,NULL,1,3),(2,4,300,NULL,1,2),(3,2,0,NULL,2,4),(3,3,316,45,1,4),(4,3,79,NULL,1,4),(5,4,0,98,1,2),(5,6,400,NULL,1,2);
...
-- Dump completed on 2026-05-16 18:40:51
