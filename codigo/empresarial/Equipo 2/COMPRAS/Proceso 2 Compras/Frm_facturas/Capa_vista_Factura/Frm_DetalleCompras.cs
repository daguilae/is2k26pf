...
{
    public partial class Frm_DetalleCompras : Form
    {
        ...
        public Frm_DetalleCompras(int idPoliza, string sModo)
        {
            InitializeComponent();
            iIdPoliza = idPoliza;
            this.sModo = sModo;
       ...
       private void CargarDetallePolizaExistente()
        ...
        private void Btn_Editar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dtDetalle.Rows[iFilaSeleccionada]["Producto"] = sCodigo;
                dtDetalle.Rows[iFilaSeleccionada]["Cantidad"] = sNombre;
                dtDetalle.Rows[iFilaSeleccionada]["Precio Unitario"] = sTipo;
                dtDetalle.Rows[iFilaSeleccionada]["Total"] = dValor;
        ...
        private void Dgv_DetallePoliza_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
